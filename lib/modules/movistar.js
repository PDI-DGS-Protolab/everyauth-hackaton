...
var google = module.exports =
    oauthModule.submodule('movistar')
        .configurable({
            scope: "URL identifying the Movistar service to be accessed." +
        ...
        .oauthHost('https://foo-test.apigee.net')
...
//        .postAccessTokenParamsVia('data')
        ...
        .entryPath('/auth/movistar')
        .callbackPath('/auth/movistar/callback')
        ...
        .fetchOAuthUser( function (accessToken) {
          var promise = this.Promise()
              , userUrl = 'https://foo-test.apigee.net/profile/me';
          request.get({
            url: userUrl,
            headers: {
